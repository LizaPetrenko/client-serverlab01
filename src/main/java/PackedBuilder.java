...
public class PackedBuilder {
    ...
    public Command decode(byte[] packed ){
        try{
            ByteBuffer wrap = ByteBuffer.wrap(packed);


            wrap.get();
            byte clientId = wrap.get(1);
            long packedId = wrap.getLong(2);
            int messageLength = wrap.getInt(10);

            byte[] messageBuffer = new byte[messageLength];

            System.arraycopy(packed, 16, messageBuffer, 0, messageLength);

            System.out.println("clientId: " + clientId + ", packed: " + packedId);
    ...
    public static void main(String[] args) {
       ...
       packet[15] = 0x0;
        ...
        System.out.println("decoded: " + decodedCommand);
    }
